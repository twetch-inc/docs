...
*/
  wallet_xpriv(): ExtendedPrivateKey | undefined;
/**
* @returns {ExtendedPublicKey | undefined}
*/
...
* @returns {ExtendedPrivateKey | undefined}
*/
  taproot_xpriv(): ExtendedPrivateKey | undefined;
/**
* @returns {ExtendedPublicKey | undefined}
*/
  taproot_xpub(): ExtendedPublicKey | undefined;
/**
* @param {string} network
* @returns {string | undefined}
*/
  display_address(network: string): string | undefined;
/**
...
* @returns {Promise<any>}
*/
  static utxos(account_public_key: PublicKey, network: string): Promise<any>;
/**
* @param {P2PKHAddress} account_address
* @param {string} network
* @returns {Promise<any>}
*/
  static account_utxos(account_address: P2PKHAddress, network: string): Promise<any>;
/**
* @param {PublicKey} account_public_key
* @param {string} network
* @returns {Promise<any>}
*/
  static wallet_utxos(account_public_key: PublicKey, network: string): Promise<any>;
/**
* @param {P2PKHAddress} account_address
* @param {string} network
* @returns {Promise<any>}
*/
  static account_balance(account_address: P2PKHAddress, network: string): Promise<any>;
}
