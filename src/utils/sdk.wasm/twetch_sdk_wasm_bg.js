...
function __wbg_adapter_42(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h33d60bbc314ac977(arg0, arg1, addHeapObject(arg2));
}
...
function __wbg_adapter_381(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h76f7939f6dd11be5(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}

/**
*/
export const Networks = Object.freeze({ TBSV:0,"0":"TBSV",BSV:1,"1":"BSV", });
/**
*/
...
export class BuiltTx {
    ...
    */
    get total_cost_sats() {
        const ret = wasm.builttx_total_cost_sats(this.ptr);
    ...
    */
    get fee_sats() {
        const ret = wasm.builttx_fee_sats(this.ptr);
        return BigInt.asUintN(64, ret);
    }
    /**
    * @returns {number}
    ...
    */
    get typed_signing() {
        const ret = wasm.builttx_typed_signing(this.ptr);
        return takeObject(ret);
    }
}
/**
...
export class PayCommand {
    ...
    */
    get users() {
        const ret = wasm.paycommand_users(this.ptr);
        return takeObject(ret);
    }
}
/**
...
export class Payee {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Payee.prototype);
        obj.ptr = ptr;
    ...
    */
    get_type(index) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.payee_get_type(retptr, this.ptr, index);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    get num_types() {
        const ret = wasm.payee_num_types(this.ptr);
        return ret >>> 0;
    }
    /**
    * @returns {string}
    */
    get user_id() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.payee_user_id(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
...
export class TwetchPayAction {
    ...
    */
    get num_payees() {
        const ret = wasm.twetchpayaction_num_payees(this.ptr);
        return ret >>> 0;
    }
    /**
    * @param {number} index
    ...
    */
    get_payee(index) {
        const ret = wasm.twetchpayaction_get_payee(this.ptr, index);
        return Payee.__wrap(ret);
    }
}
/**
*/
...
export class Wallet {
    ...
    */
    ...
    /**
    * @returns {ExtendedPrivateKey | undefined}
    */
    wallet_xpriv() {
        const ret = wasm.wallet_wallet_xpriv(this.ptr);
        return ret === 0 ? undefined : ExtendedPrivateKey.__wrap(ret);
    }
    /**
    * @returns {ExtendedPublicKey | undefined}
    */
    ...
    */
    taproot_xpriv() {
        const ret = wasm.wallet_taproot_xpriv(this.ptr);
        return ret === 0 ? undefined : ExtendedPrivateKey.__wrap(ret);
    }
    /**
    * @returns {ExtendedPublicKey | undefined}
    */
    taproot_xpub() {
        const ret = wasm.wallet_taproot_xpub(this.ptr);
        return ret === 0 ? undefined : ExtendedPublicKey.__wrap(ret);
    }
    /**
    ...
    */
    display_address(network) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.wallet_display_address(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            let v1;
            if (r0 !== 0) {
    ...
    */
    static utxos(account_public_key, network) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wallet_utxos(ptr0, ptr1, len1);
        return takeObject(ret);
    }
    /**
    ...
    */
    static account_utxos(account_address, network) {
        ...
        const ptr1 = passStringToWasm0(network, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wallet_account_utxos(ptr0, ptr1, len1);
        return takeObject(ret);
    }
    /**
    * @param {PublicKey} account_public_key
    ...
    */
    static wallet_utxos(account_public_key, network) {
        ...
        const ptr1 = passStringToWasm0(network, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wallet_wallet_utxos(ptr0, ptr1, len1);
        return takeObject(ret);
    }
    /**
    * @param {P2PKHAddress} account_address
    ...
    */
    static account_balance(account_address, network) {
        ...
        const ptr1 = passStringToWasm0(network, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wallet_account_balance(ptr0, ptr1, len1);
        return takeObject(ret);
    }
}
...
export function __wbg_decodeURIComponent_0183f5f5ec5752fc() { return handleError(function (arg0, arg1) {
...
export function __wbindgen_closure_wrapper2325(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 655, __wbg_adapter_42);
    return addHeapObject(ret);
};
