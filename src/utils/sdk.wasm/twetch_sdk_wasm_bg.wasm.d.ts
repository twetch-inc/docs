...
export function wallet_wallet_xpriv(a: number): number;
export function wallet_wallet_xpub(a: number): number;
export function wallet_taproot_xpriv(a: number): number;
export function wallet_taproot_xpub(a: number): number;
export function wallet_display_address(a: number, b: number, c: number, d: number): void;
...
export function wallet_utxos(a: number, b: number, c: number): number;
export function wallet_account_utxos(a: number, b: number, c: number): number;
export function wallet_wallet_utxos(a: number, b: number, c: number): number;
export function wallet_account_balance(a: number, b: number, c: number): number;
...
export function builttx_total_cost_sats(a: number): number;
export function builttx_fee_sats(a: number): number;
...
export function builttx_typed_signing(a: number): number;
...
export function paycommand_users(a: number): number;
...
export function __wbg_payee_free(a: number): void;
export function __wbg_twetchpayaction_free(a: number): void;
export function payee_get_type(a: number, b: number, c: number): void;
export function payee_num_types(a: number): number;
export function payee_user_id(a: number, b: number): void;
...
export function twetchpayaction_num_payees(a: number): number;
export function twetchpayaction_get_payee(a: number, b: number): number;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h33d60bbc314ac977(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h76f7939f6dd11be5(a: number, b: number, c: number, d: number): void;
