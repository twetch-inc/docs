...
This is a rolling address derivation. If you're bsv balance is not showing up in yours wallet, it is because the funds are in these rolling addresses. You can try using electrum or simply cash to recover these funds.
